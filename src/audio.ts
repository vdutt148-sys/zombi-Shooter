// Procedural Audio Synthesizer using Web Audio API (Zero external audio assets required)
...
class SoundSystem {
  ...
  private playNoise(duration: number, volume: number, lowpassFreq: number) {
    if (!this.ctx) return;
